...
{
    class ShipAsteroidCollision : StaticCollision
    {
        SoundBank soundBank;
        ...
        /// <summary>
        /// Default constructor for a collision between the ship and an asteroid.
        /// </summary>
        ...
        /// <param name="ship">A reference to the ship.</param>
        /// <param name="asteroids">A reference to the list of asteroids.</param>
        public ShipAsteroidCollision(SoundBank soundBank, ExplosionList explosions, Ship ship, AsteroidList asteroids)
            : base()
        {
